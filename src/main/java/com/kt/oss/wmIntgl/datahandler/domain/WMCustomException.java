...
@XmlRootElement(name = "wMCustomException")
public class WMCustomException implements Serializable {

	private static final long serialVersionUID = 6955530435055144872L;
	private int bt360ExceptionType;
	...
	public int getBt360ExceptionType() {
		return bt360ExceptionType;
	}

	public void setBt360ExceptionType(int bt360ExceptionType) {
	...
	public int getUseStatusChange() {
		return useStatusChange;
	}

	public void setUseStatusChange(int useStatusChange) {
	...
	public String toString() {
		...
		builder.append("\r\nWMCustomException [bt360ExceptionType=");
