...
@XmlRootElement(name = "wMAppointmentCancel")
public class WMAppointmentCancel implements Serializable {

	private static final long serialVersionUID = -5061003263733657848L;
