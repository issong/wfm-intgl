...
@XmlRootElement(name = "wMResourceInfoParam")
public class WMResourceInfoParam implements Serializable {
	...
	private List<WMWorkTeamParam> wMWorkTeamParams;
	...
	public List<WMWorkTeamParam> getwMWorkTeamParams() {
		if (wMWorkTeamParams == null) {
			wMWorkTeamParams = new ArrayList<WMWorkTeamParam>();
		}
		return wMWorkTeamParams;
	}

	public void setwMWorkTeamParams(List<WMWorkTeamParam> wMWorkTeamParams) {
		this.wMWorkTeamParams = wMWorkTeamParams;
	}
	...
	public String toString() {
		...
		builder.append("\r\nWMResourceInfoParam [officeScodes=");
		...
		builder.append("\r\n, wMWorkTeamParams=");
		builder.append(wMWorkTeamParams);
		builder.append("]");
