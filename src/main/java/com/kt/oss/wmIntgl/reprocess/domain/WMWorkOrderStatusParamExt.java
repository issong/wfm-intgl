...
public class WMWorkOrderStatusParamExt implements Serializable {

	private WMWorkOrderStatusParam order;
	...
	public WMWorkOrderStatusParam getOrder() {
		return order;
	}

	public void setOrder(WMWorkOrderStatusParam order) {
		this.order = order;
	}
