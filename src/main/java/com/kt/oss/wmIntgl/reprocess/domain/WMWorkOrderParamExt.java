...
public class WMWorkOrderParamExt implements Serializable {

	private WMWorkOrderParam order;
	...
	public WMWorkOrderParam getOrder() {
		return order;
	}

	public void setOrder(WMWorkOrderParam order) {
		this.order = order;
	}
