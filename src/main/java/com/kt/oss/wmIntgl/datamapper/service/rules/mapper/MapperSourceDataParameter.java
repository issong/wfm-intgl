 ...
 * @see
 */
public class MapperSourceDataParameter extends RulesMapper {

	/**
	 * SourceDataParameter 항목의 데이터를 적재한다.
	 * 
	 * @param drls
	 * @return
	 * @throws Exception
	...
	public List<Object> generate(_Rules drls, IntglDataVo intglVo,
			...
			throws Exception {
		for (int i = 0; i < 2; i++) {
			executeGenerate(drls, new Integer(i), intglVo, rulesVo, rulesDB,
	...
	protected Object getTargetObject() {
		return new ObjectFactory().createDsScheduleDataSourceDataParameter();
	}
}
