 ...
 * @see
 */
public class MapperWMWorkOrderStatus extends RulesMapper {

	/**
	 * WMWorkOrderStatus 항목의 데이터를 적재한다.
	 * 
	 * @param drls
	 * @return
	 * @throws Exception
	...
	public List<Object> generate(_Rules drls, IntglDataVo intglVo,
		...
		for (Object order : dsScheduleData
			...
			// ActivityStatus 일경우만 변환 수행
			if (order instanceof DsScheduleData.ActivityStatus) {
