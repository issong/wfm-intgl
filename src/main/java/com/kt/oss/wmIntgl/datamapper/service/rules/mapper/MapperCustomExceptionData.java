 ...
 * @see
 */
public class MapperCustomExceptionData extends RulesMapper {

	/**
	 * CustomExceptionData 항목의 데이터를 적재한다.
	 * 
	 * @param drls
	 * @return
	 * @throws Exception
	...
	public List<Object> generate(_Rules drls, IntglDataVo intglVo,
		...
		for (Object order : intglVo.getSourceData()) {
			...
			case VS4:
				WMWorkOrderStatus wmWorkOrderStatus = (WMWorkOrderStatus) order;
				if (StringUtil.isEmpty(wmWorkOrderStatus
						.getBt360FixedWorkerId())) {
					rulesVo.setLabel("구분");
					rulesVo.setValue("완료오더-작업자사번부재");
	...
	protected Object getTargetObject() {
		return new ObjectFactory().createDsScheduleDataCustomExceptionData();
	}
}
