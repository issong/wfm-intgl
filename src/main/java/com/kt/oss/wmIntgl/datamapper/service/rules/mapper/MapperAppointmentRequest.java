 ...
 * @see
 */
public class MapperAppointmentRequest extends RulesMapper {

	/**
	 * AppointmentRequest 항목의 데이터를 적재한다.
	 * 
	 * @param drls
	 * @return
	 * @throws Exception
	...
	protected Object getTargetObject() {
		return new ObjectFactory().createDsScheduleDataAppointmentRequest();
	}
}
