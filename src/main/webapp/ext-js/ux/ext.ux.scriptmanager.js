/*
 * ExtJS Dynamic Javascript Loader
 * 
 * 출처 : http://www.sencha.com/forum/showthread.php?37897-dynamically-load-javascript
 * 
 * usage:
 * ScriptMgr.loadJs({
 ...
 * 
 * ScriptMgr.loadCss({
 *    scripts: ['/css/other-prerequisite.css', '/css/other.css']
 * });
 */
var ScriptMgr;
	...
	Ext.ux.ScriptManager = Ext.extend(Ext.util.Observable, {
	    ...
	    */
	    ...
	    processSuccess : function(response) {
	    	if (response.argument == undefined) {
	    		response.argument = response.request.options.argument;
	    	}
